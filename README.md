...
- [x402-layer-skill](https://github.com/ivaavimusic/singularity-skill/tree/main/singularity) - AI coding skill for x402 Singularity Layer covering HTTP 402 payments, USDC settlement on Solana/Base, API monetization, marketplace listings, webhooks, and ERC-8004 agent registration.
- [x402-compute-skill](https://github.com/ivaavimusic/SGL_DOCS_2025/tree/main/skills/x402-compute) - AI coding skill for x402 Compute covering GPU/VPS provisioning and management with USDC payment via the x402 protocol on Solana and Base networks.
